...
class Dispatch {
    constructor(connection) {
        ...
        this.sysmsgMap = this.connection.metadata.sysmsgMap;
        this.protocolMap = this.connection.metadata.protocolMap;
        this.protocol = this.connection.metadata.protocol;
        this.latestDefVersion = this.connection.metadata.latestDefVersion;
